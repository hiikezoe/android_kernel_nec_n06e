...
static struct clk_lookup msm_clocks_8064[] = {
	...
	CLK_LOOKUP("gp1_clk",		gp1_clk.c,		NULL),
	...
	CLK_LOOKUP("core_clk",		gsbi7_uart_clk.c, "msm_serial_hs.2"),
	...
	CLK_LOOKUP("iface_clk",		gsbi7_p_clk.c,		"msm_serial_hs.2"),
	...
	CLK_LOOKUP("cam_clk",		cam2_clk.c,	"4-003d"),
