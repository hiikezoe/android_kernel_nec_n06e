...
#if !defined(__BOARD_8064_REGULATOR_OEM_H__)
#define __BOARD_8064_REGULATOR_OEM_H__
...
VREG_CONSUMERS(L16) = {
	...
	REGULATOR_SUPPLY("dsi1_vci",	"mipi_dsi.1"),
...
VREG_CONSUMERS(L17) = {
	...
	REGULATOR_SUPPLY("dsi1_vdd3",	"mipi_dsi.1"),
...
VREG_CONSUMERS(L25) = {
	...
	REGULATOR_SUPPLY("mhl_l25",			"0-0039"),
...
VREG_CONSUMERS(S4) = {
	...
	REGULATOR_SUPPLY("mhl_s4",			"0-0039"),
...
VREG_CONSUMERS(L5_PC)   = {
	REGULATOR_SUPPLY("8921_l5_pc",     NULL),
};
...
apq8064_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_LDO(L11, 0, 1, 0, 2700000, 2700000, NULL,          0,     0),  
	...
	RPM_LDO(L17, 0, 1, 0, 2700000, 2700000, NULL,          0,     0),  
	...
	RPM_PC_INIT(L5,  0, SLEEP_B, RPM_VREG_PIN_CTRL_NONE,  "8921_l5"), 
