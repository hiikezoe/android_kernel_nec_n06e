...
#define REG_USB_CHARGE_PUMP 0x00F8

#define REG_DPD         0x003D


#define REG_TMDS0_CCTRL2    0x0000

#define REG_DVI_CTRL3	0x0005

#define REG_TMDS_CLK_EN 0x0011
#define REG_TMDS_CH_EN  0x0012
#define REG_TMDS_TERMCTRL1 0x0013

#define REG_PLL_CALREFSEL  0x0017
#define REG_PLL_VCOCAL   0x001A

#define REG_EQ_DATA0     0x0022
#define REG_EQ_DATA1     0x0023
#define REG_EQ_DATA2     0x0024
#define REG_EQ_DATA3     0x0025
#define REG_EQ_DATA4     0x0026
#define REG_EQ_DATA5     0x0027
#define REG_EQ_DATA6     0x0028
#define REG_EQ_DATA7     0x0029

#define REG_BW_I2C       0x0031

#define REG_EQ_PLL_CTRL1     0x0045

#define REG_MON_USE_COMP_EN  0x004B
#define REG_ZONE_CTRL_SW_RST  0x004C
#define REG_MODE_CONTROL     0x004D

#define REG_DISC_CTRL1	 0x0010		
#define REG_DISC_CTRL2	 0x0011		
#define REG_DISC_CTRL3	 0x0012		
#define REG_DISC_CTRL4	 0x0013		
#define REG_DISC_CTRL5	 0x0014		
#define REG_DISC_CTRL6	 0x0015		
#define REG_DISC_CTRL7	 0x0016		
#define REG_DISC_CTRL8	 0x0017		
#define REG_DISC_CTRL9	 0x0018
#define REG_DISC_CTRL10	 0x0019
#define REG_DISC_CTRL11	 0x001A
#define REG_DISC_STAT	 0x001B		
#define REG_DISC_STAT2	 0x001C		

#define REG_INT_CTRL	 0x0020		
#define REG_INTR4		 0x0021		
#define     INTR4_SCDT_CHANGE 0x01
#define REG_INTR4_MASK	 0x0022		
#define REG_INTR5		 0x0023
#define REG_INTR5_MASK	 0x0024

#define REG_MHLTX_CTL1	 0x0030		
#define REG_MHLTX_CTL2	 0x0031		
#define REG_MHLTX_CTL3	 0x0032		
#define REG_MHLTX_CTL4	 0x0033		
#define REG_MHLTX_CTL5	 0x0034		
#define REG_MHLTX_CTL6	 0x0035		
#define REG_MHLTX_CTL7	 0x0036		
#define REG_MHLTX_CTL8	 0x0037

#define REG_TMDS_CSTAT	 0x0040
#define     TMDS_CSTAT_SCDT 0x02

#define REG_MIPI_DSI_CTRL		 0x0092
#define REG_MIPI_DSI_FORMAT		 0x0093
#define REG_MIPI_DSI_PXL_FORMAT	 0x0094
...
#define REG_CBUS_COMMON_CONFIG           0x0007
#define REG_CBUS_INTR_STATUS             0x0008
#define BIT_CBUS_CNX_CHG        BIT0
#define BIT_CBUS_CEC_ABRT       BIT1    
#define BIT_CBUS_DDC_ABRT       BIT2    
#define BIT_CBUS_MSC_MR_MSC_MSG BIT3    
#define BIT_CBUS_MSC_MT_DONE    BIT4    
#define BIT_CBUS_MSC_MT_ABRT    BIT5    
...
#define REG_CBUS_INTR_ENABLE             0x0009
...
#define REG_DDC_ABORT_REASON        	 0x000B
#define REG_CBUS_BUS_STATUS              0x000A
#define BIT_BUS_CONNECTED                   0x01
#define BIT_LA_VAL_CHG                      0x02

#define REG_PRI_XFR_ABORT_REASON         0x000D

#define REG_CBUS_PRI_FWR_ABORT_REASON    0x000E
...
#define REG_CBUS_PRI_START               0x0012
...
#define REG_CBUS_PRI_ADDR_CMD            0x0013
#define REG_CBUS_PRI_WR_DATA_1ST         0x0014
#define REG_CBUS_PRI_WR_DATA_2ND         0x0015
#define REG_CBUS_PRI_RD_DATA_1ST         0x0016
#define REG_CBUS_PRI_RD_DATA_2ND         0x0017

#define REG_CBUS_PRI_VS_CMD              0x0018
#define REG_CBUS_PRI_VS_DATA             0x0019

#define	REG_CBUS_MSC_RETRY_INTERVAL		 0x001A		
#define	REG_CBUS_DDC_FAIL_LIMIT			 0x001C		
#define	REG_CBUS_MSC_FAIL_LIMIT			 0x001D		

#define	REG_CBUS_MSC_INT2_STATUS         0x001E
...
#define REG_CBUS_MSC_INT2_ENABLE         0x001F
...
#define	REG_MSC_WRITE_BURST_LEN          0x0020       
#define     MSC_MT_DONE_NACK_MASK       BIT6
#define     MSC_WRITE_BURST_LEN_MASK    0x0F

#define REG_MSC_TIMEOUT_LIMIT            0x0022
#define	MSC_TIMEOUT_LIMIT_MSB_MASK	        0x0F	        
#define	MSC_LEGACY_BIT					    (0x01 << 7)	    

#define REG_CBUS_MSC_COMPATIBILITY_CTRL  0x002E
#define BIT_CBUS_CEC_DISABLE            BIT4


#define	REG_CBUS_LINK_CONTROL_1			 0x0030
#define BIT_CBUS_PACKET_LIMIT_MASK      0x1F

#define	REG_CBUS_LINK_CONTROL_2			 0x0031
#define BIT_CBUS_INITIATOR_TIMEOUT_MASK 0x0C

#define	REG_CBUS_LINK_CONTROL_3			 0x0032
#define	REG_CBUS_LINK_CONTROL_4			 0x0033
#define	REG_CBUS_LINK_CONTROL_5			 0x0034
#define	REG_CBUS_LINK_CONTROL_6			 0x0035
#define	REG_CBUS_LINK_CONTROL_7			 0x0036
#define REG_CBUS_LINK_STATUS_1           0x0037
#define REG_CBUS_LINK_STATUS_2           0x0038
#define	REG_CBUS_LINK_CONTROL_8			 0x0039
#define	REG_CBUS_LINK_CONTROL_9			 0x003A
#define	REG_CBUS_LINK_CONTROL_10		 0x003B
#define	REG_CBUS_LINK_CONTROL_11		 0x003C
#define	REG_CBUS_LINK_CONTROL_12		 0x003D


#define REG_CBUS_LINK_CTRL9_0			 0x003A
#define REG_CBUS_LINK_CTRL9_1            0x00BA

#define	REG_CBUS_DRV_STRENGTH_0			 0x0040
#define	REG_CBUS_DRV_STRENGTH_1			 0x0041
#define	REG_CBUS_ACK_CONTROL			 0x0042
#define	REG_CBUS_CAL_CONTROL			 0x0043	

#define REG_CBUS_DEVICE_CAP_0            0x0080
#define REG_CBUS_DEVICE_CAP_1            0x0081
#define REG_CBUS_DEVICE_CAP_2            0x0082
#define REG_CBUS_DEVICE_CAP_3            0x0083
#define REG_CBUS_DEVICE_CAP_4            0x0084
#define REG_CBUS_DEVICE_CAP_5            0x0085
#define REG_CBUS_DEVICE_CAP_6            0x0086
#define REG_CBUS_DEVICE_CAP_7            0x0087
#define REG_CBUS_DEVICE_CAP_8            0x0088
#define REG_CBUS_DEVICE_CAP_9            0x0089
#define REG_CBUS_DEVICE_CAP_A            0x008A
#define REG_CBUS_DEVICE_CAP_B            0x008B
#define REG_CBUS_DEVICE_CAP_C            0x008C
#define REG_CBUS_DEVICE_CAP_D            0x008D
#define REG_CBUS_DEVICE_CAP_E            0x008E
#define REG_CBUS_DEVICE_CAP_F            0x008F

#define REG_CBUS_SET_INT_0				 0x00A0
#define REG_CBUS_SET_INT_1				 0x00A1
#define REG_CBUS_SET_INT_2				 0x00A2
#define REG_CBUS_SET_INT_3				 0x00A3

#define REG_CBUS_WRITE_STAT_0        	 0x00B0
#define REG_CBUS_WRITE_STAT_1        	 0x00B1
#define REG_CBUS_WRITE_STAT_2        	 0x00B2
#define REG_CBUS_WRITE_STAT_3        	 0x00B3


#define REG_CBUS_SCRATCHPAD_0            0x00C0

#define REG_CBUS_WRITE_STAT_ENABLE_0     0x00E0
#define REG_CBUS_WRITE_STAT_ENABLE_1     0x00E1
#define REG_CBUS_WRITE_STAT_ENABLE_2     0x00E2
#define REG_CBUS_WRITE_STAT_ENABLE_3     0x00E3

#define REG_CBUS_SET_INT_ENABLE_0     0x00F0
#define REG_CBUS_SET_INT_ENABLE_1     0x00F1
#define REG_CBUS_SET_INT_ENABLE_2     0x00F2
#define REG_CBUS_SET_INT_ENABLE_3     0x00F3
