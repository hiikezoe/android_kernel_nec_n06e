...
#elif YAS_GYRO_DRIVER == YAS_GYRO_DRIVER_L3G4200D
#define YAS_GYRO_DEFAULT_FILTER_THRESH		(280) 
#elif YAS_GYRO_DRIVER == YAS_GYRO_DRIVER_EWTZMU
#define YAS_GYRO_DEFAULT_FILTER_THRESH		(320) 
#else
#define YAS_GYRO_DEFAULT_FILTER_THRESH		(0)
#endif
...
#if YAS_ACC_DRIVER == YAS_ACC_DRIVER_NONE 	|| YAS_MAG_DRIVER == YAS_MAG_DRIVER_NONE 	|| YAS_GYRO_DRIVER == YAS_GYRO_DRIVER_NONE
