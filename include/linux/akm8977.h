...
#if !defined(akm8977_H)
#define akm8977_H

#include <linux/ioctl.h>


#define AKECS_MODE_POWERDOWN	0x00	
#define AKECS_MODE_MEASURE_SNG	0x01	
#define AKECS_MODE_MEASURE_SEQ	0x02	
#define AKECS_MODE_E2P_READ	    0x04	
#define AKECS_MODE_SELF_TEST	0x08	
...
#define AK8977_SLCT1_PEEN           0x04
#define AK8977_SLCT2_LFEN           0x08
...
#define ECS_IOCTL_PEDO_OFF              _IOR(AKMIO, 0x94, int)
#define ECS_IOCTL_PEDO_ON               _IOR(AKMIO, 0x95, int)

#define ECS_IOCTL_SET_ACCEL_MODE        _IOW(AKMIO, 0x96, int)
#define ECS_IOCTL_GET_ACCEL_MODE        _IOR(AKMIO, 0x97, int)

#define ECS_IOCTL_CLEAR_INT_STATUS      _IO(AKMIO, 0x97)
...
extern int AKM_vib_off(void);        
extern int AKM_vib_on(void);         
extern int AKM_speaker_off(void);    
extern int AKM_speaker_on(void);     

#define AKMD_ACCELERATION_MODE_LOCK_LANDSCAPE       (0)
#define AKMD_ACCELERATION_MODE_NORMAL               (1)
